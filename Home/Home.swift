...
struct Home: View {
    ...
    /// View Properties
    @State private var activeTab: ProductType = .chair
        ...
        .toolbar {
            ToolbarItemGroup(placement: .navigationBarTrailing) {
                                Button(action: {
                                    ...
                                    Image(systemName: cart.cartItems.count == 0 ? "cart" : "cart.badge.plus")
...
//                            .cornerRadius(25)
            ...
            tempView(item:[product.productImage])
                               }
    }
}
